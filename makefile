...
create_utilities: ## Installs helm cluster utilities charts, sets -var 'dry_run=true' , -var 'deploy_cluster=true' ,-var 'update_cluster=false'. Specific utility, module=name
...
destroy_utilities: ## Uninstalls helm cluster utilities charts. Specific utility, module=name
...
ifdef module
	...
	terraform apply -target=module.kops_cluster.module -auto-approve \
	 -var 'dry_run=false' \
  	 -var 'deploy_cluster=true' \
 	 -var 'update_cluster=true' \
	 -var 'destroy_cluster=false'
