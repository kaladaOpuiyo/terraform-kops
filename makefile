...
all: init create_user create_cluster create_utilities create_addons ## Create all resources
destroy_all: init destroy_addons destroy_utilities destroy_cluster destroy_user    ## Destroy all resources
